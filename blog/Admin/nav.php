...
<div class="main">
  ...
  <tr>
    ...
    <td><label for="txtname">导航名称</label></td>
    <td><label for="txtname">导航url地址栏</label></td>
    ...
    <td><label for="txtname">操作</label></td>
	  ...
	  <tr>
	    ...
	    <td><label for="txtname"><a href="editNav.php?id=<?php echo $v['id'];?>">修改</a> | <a href="delNav.php?id=<?php echo $v['id'];?>" onclick="if(!confirm('确定删除该导航吗？')){return false;}">删除</a></label></td>
	  </tr>
	<?php 
		}
	} else {?>
